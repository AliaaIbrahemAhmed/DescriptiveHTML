...
public class LanguageTokens implements LanguageTokensConstants {
  ...
  public static void main(String args[]) throws ParseException {
    LanguageTokens parser = new LanguageTokens(System.in);
    parser.Input();
  }
  ...
  static final public void Input() throws ParseException {
    ...
    while (true) {
      ...
      case SmallLetter:{
        jj_consume_token(SmallLetter);
        break;
        }
      case CapitalLetter:{
        jj_consume_token(CapitalLetter);
        break;
        }
      case Dott:{
        jj_consume_token(Dott);
        break;
        }
      case Colon:{
